...
wnba_stats %>% 
  ...
  geom_point() +
  labs(
    title = "Percetange metric values for players who had at least 10 attempts",
    y = "",
    x = "Percetange of successes"
    ) +
...
Among players with more than 20 attempts there were virtually none who had a higher success rate than 70%. A similar case can be made for the lower range.
