...
Each dataset followed a different pattern of preferable gradient-boosting parameters.
When judging by R-squared, for most datasets better predictions were achieved with a higher number boosting iterations and learning 

When judging by R-squared, models fitted to the full dataset with a log-transformed salary, tended to return better predictions with a higher learning rate
