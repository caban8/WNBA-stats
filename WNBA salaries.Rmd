...
# Load all libraries
pacman::p_load(DT, readxl,leaps,furrr, rstatix, broom, bestglm, glmnet, leaps, car,  pROC, caret, tree, rpart, randomForest, rpart.plot, tidyverse, doParallel)
...
cross_forest <- function(data) {
  ...
  mtry <- data.frame(mtry = seq(2,sqrt(ncol(data)) + 7, 2)) # Na razie mniej, żeby nie przegrzewać procków
